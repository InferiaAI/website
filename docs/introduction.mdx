...
1.  **[Inference Gateway](/api-reference/inference-gateway)**: The high-performance entry point for API requests.
2.  **[Filtration Gateway](/api-reference/filtration-gateway)**: The security engine responsible for guardrails and policy enforcement.
3.  **[Orchestration Gateway](/api-reference/orchestration-gateway)**: The control plane that manages compute resources and model deployments.

## Getting Started

Ready to dive in?

-   **[Quickstart](/quickstart)**: Run the full stack locally with Docker.
-   **[Installation](/user-guide/installation)**: Manual setup guide for individual services.
-   **[Architecture](/developer/architecture)**: Deep dive into the system design.
