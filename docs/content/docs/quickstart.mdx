...
If you prefer containerization, use the `deploy` directory. You can also view our official images on [Docker Hub](https://hub.docker.com/r/inferiaai/inferiallm).
...
1.  **Configure Environment**:
    ...
    # Note: deploy/unified uses ../.env, so ensure it is configured
    ```
